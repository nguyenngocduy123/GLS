...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__planner_notes__ = __webpack_require__(1127);
...
var PlannerNotesPage = /** @class */ (function (_super) {
    ...
    PlannerNotesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-planner-notes',template:/*ion-inline-start:"G:\GLS\TMS SC\New folder\driver-v2\src\pages\all-jobs\planner-notes\planner-notes.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <vrp-header>{{\'PAGE.PLANNER_NOTES.Header\' | translate}}</vrp-header>\n\n\n\n        <button end ion-button menuToggle="right">\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-list>\n\n        <ion-item-group *ngFor="let job of driver.jobs">\n\n            <ng-container *ngIf="job.NoteFromPlanner.length">\n\n                <ion-item-divider sticky>\n\n                    <ion-label item-start>\n\n                        <strong>#{{job.DeliveryMasterId}}</strong>\n\n                    </ion-label>\n\n                    <vrp-jobtype-label [jobtype]="job.JobType" item-end></vrp-jobtype-label>\n\n                </ion-item-divider>\n\n\n\n                <ion-item text-wrap>\n\n                    <vrp-jobnote-label [notes]="job.NoteFromPlanner"></vrp-jobnote-label>\n\n                </ion-item>\n\n            </ng-container>\n\n        </ion-item-group>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"G:\GLS\TMS SC\New folder\driver-v2\src\pages\all-jobs\planner-notes\planner-notes.html"*/,
        }),
