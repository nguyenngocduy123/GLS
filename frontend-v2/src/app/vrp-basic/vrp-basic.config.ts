...
export const PROBLEMDETAIL_TABLE_CONFIG: any = configTransform({
    'vehicles': [
        ...
        { name: 'type_id', label: 'Type', type: 'select', 'source_data_id': 'vehicle_types', width: 120 },
        { name: 'earliest_start', label: 'Start Time', type: 'dateTime', width: 150 },
        { name: 'latest_end', label: 'End Time', type: 'dateTime', width: 150 },
        { name: 'break_time_windows', label: 'Break Timewindow', type: 'timeWindow', width: 150, hidden: true },
        { name: 'break_duration', label: 'Break Duration (m)', type: 'number', scale: 1.0 / 60, hidden: true },
        { name: 'start_address', label: 'Start Address', type: 'address', width: { min: 100, max: 400 }, rowIndex: 1 },
        { name: 'end_address', label: 'End Address', type: 'address', width: { min: 100, max: 400 }, rowIndex: 1 },
        { name: 'return_to_depot', label: 'Return', type: 'boolean', width: 80, rowIndex: 1 },
    ...
    'services': [
        ...
        { name: 'size', label: 'Demand', type: 'array', 'source_data_id': 'items' },
    ...
    'shipments': [
        ...
        { name: 'size', label: 'Demand', type: 'array', 'source_data_id': 'items', width: 120 },
