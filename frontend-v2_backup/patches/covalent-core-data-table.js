...
var TdDataTableComponent = /** @class */ (function (_super) {
    ...
    TdDataTableComponent.prototype._adjustColumnWidhts = function () {
        ...
        var /** @type {?} */ flexibleWidths = this._widths.filter(function (width, index) {
            // if(!_this.columns[index]){ //hacky
            //     console.log('invalid index',index,_this.columns, this._widths);//hacky
            // }//hacky
        ...
        if (flexibleWidths && recalculateHostWidth) {
            ...
            var /** @type {?} */ newFlexibleWidths = this._widths.filter(function (width,index) {
                ...
                return !width.limit && !width.max && !width.min;//hacky
            }).length;
            if (newFlexibleWidths !== adjustedNumber_1 && newFlexibleWidths !== flexibleWidths) {
                // console.debug('newFlexibleWidths', newFlexibleWidths,adjustedNumber_1,flexibleWidths);//hacky
                // console.debug('recalculateHostWidth', recalculateHostWidth,this._widths.length);//hacky
                this._adjustColumnWidhts();
            }
        }
    };
