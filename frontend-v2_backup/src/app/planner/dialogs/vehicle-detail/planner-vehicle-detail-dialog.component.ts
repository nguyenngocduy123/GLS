...
export class PlannerVehicleDetailDialogComponent implements OnInit, OnDestroy {
    ...
    private _tableName: DuplicatesTableNames = 'vehicle';
    ...
    constructor(
        ...
        this.f = new FormGroup({
            ...
            PlateNumber: new FormControl(
                'XXXXXX',
                [
                    Validators.pattern(PLATENUMBER_REGEX_PATTERN),
                ],
            ),
            ...
            MaxNumJobs: new FormControl(1000, [
                Validators.min(1),
            ]),
            StartAddressPostal: new FormControl(
                ...
                [
                    ...
                    VrpValidators.postalExistValidator(this._geocode, (res) => this._setCoords('Start', res)),
                ],
            ),
            EndAddressPostal: new FormControl(
                ...
                [
                    ...
                    VrpValidators.postalExistValidator(this._geocode, (res) => this._setCoords('End', res)),
                ],
            ),
        });
    ...
    private _validateExistingId(): AsyncValidatorFn {
        return (control: AbstractControl): any => {
            ...
            return this._plannerRest.checkForDuplicates([control.value], this._tableName).pipe(map((existingIds) => {
                // Id already exists
                if (this.createNew && existingIds.length > 0) {
